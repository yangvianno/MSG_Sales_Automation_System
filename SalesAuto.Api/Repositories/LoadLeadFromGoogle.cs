...
{
    public class LoadLeadFromGoogle
    {
        [Obsolete]
        public static void DownFileNew(string FileName)
        {
            UserCredential credential;

            // If modifying these scopes, delete previously saved token.json
            string[] Scopes = { DriveService.Scope.DriveReadonly };
            string ApplicationName = "LayFileLeads";
            string fileId = "1XqPTxPprvvodUNPl01BmVEmmYJ_BdSlhKe04kQ7RlPY";
            string path = FileName; //Include filename & extension i.e. C:\stuff\sheet001.xlsx
